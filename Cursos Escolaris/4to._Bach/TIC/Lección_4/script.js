document.addEventListener('DOMContentLoaded', () => {
        ...
        options.forEach(option => {
            option.addEventListener('click', () => {
                ...
                if (isCorrect) {
                    ...
                    feedbackText.textContent = "✅ ¡Excelente! Has demostrado un gran criterio para evaluar la confiabilidad de la información.";
                    retryBtn.classList.add('hidden');
                } else {
                    option.classList.add('wrong');
                    feedback.classList.remove('hidden');
                    feedback.className = 'feedback error';
                    feedbackText.textContent = "❌ No es correcto. Recuerda que en investigación académica, la falta de fechas o autores reduce drásticamente la fiabilidad.";
    ...
    function checkGameResult() {
        ...
        if (isCorrect) {
            ...
            gameFeedbackText.textContent = "⭐ ¡Perfecto! El flujo correcto asegura que no recopiles basura informativa. ¡Buen trabajo!";
            gameFeedback.querySelector('.retry-btn').classList.add('hidden');
        } else {
            gameFeedback.className = "feedback error";
            gameFeedbackText.textContent = "😟 El orden no es el indicado. Primero planeamos, luego recopilamos y al final filtramos. ¡Intenta de nuevo!";
