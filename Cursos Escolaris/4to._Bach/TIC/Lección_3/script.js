document.addEventListener('DOMContentLoaded', () => {
        ...
        options.forEach(option => {
            option.addEventListener('click', () => {
                ...
                if (isCorrect) {
                    ...
                    feedbackText.textContent = "✅ ¡Excelente! Identificaste correctamente la fuente. La validación es clave.";
                    retryBtn.classList.add('hidden');
                } else {
                    option.classList.add('wrong');
                    feedback.classList.remove('hidden');
                    feedback.className = 'feedback error';
                    feedbackText.textContent = "❌ No es del todo correcto. Recuerda que la fiabilidad depende del autor y el respaldo técnico. ¡Inténtalo de nuevo!";
    ...
    function checkGameResult() {
        ...
        if (isCorrect) {
            ...
            gameFeedbackText.textContent = "⭐ ¡Perfecto! Primero definimos el problema, luego investigamos y finalmente creamos el producto.";
            gameFeedback.querySelector('.retry-btn').classList.add('hidden');
        } else {
            gameFeedback.className = "feedback error";
            gameFeedbackText.textContent = "😟 El orden no es el indicado. El ABP sigue un proceso lógico. ¡Intenta de nuevo!";
