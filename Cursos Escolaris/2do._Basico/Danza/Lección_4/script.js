...
window.checkSimpleOption = function (btn, isCorrect, feedbackId, successTxt, errorTxt) {
    ...
    if (isCorrect) {
        ...
        feedback.innerText = successTxt || "¡Muy bien! Esa es la respuesta correcta. ✨";
        feedback.className = "feedback success";
    } else {
        btn.classList.add('incorrect');
        feedback.innerText = errorTxt || "Casi, pero no. ¡Sigue intentando! 💪";
...
window.showPointInfo = function (pointId, infoId, text) {
    ...
    if (act) act.style.backgroundColor = 'var(--primary-yellow)';
}
